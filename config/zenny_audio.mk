...
ALARM_PATH := vendor/zenny/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/zenny/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/zenny/prebuilt/common/media/audio/ringtones
